...
class Detr:
     ...
     def save(self):
        xm.save((self.model.state_dict(), f'saved_models/{args.run_name}')
...
train_para_loader = pl.ParallelLoader(train_dataloader, [model.device])
test_para_loader = pl.ParallelLoader(train_dataloader, [model.device])


for i, batch in enumerate(train_para_loader):
    model.training_step(batch)
    print(i)

model.validation_step(test_para_loader.next())
